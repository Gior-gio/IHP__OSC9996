...
C {ROI_LIF_NEURON_UNIC-CASS/work/integrator/xschem/integrator.sym} 120 -80 0 0 {name=xINT}
C {ROI_LIF_NEURON_UNIC-CASS/work/spike_generator/xschem/spike_generator.sym} 940 -210 0 0 {name=xSPK}
...
C {ROI_LIF_NEURON_UNIC-CASS/work/resistance_bank/resistence_bank.sym} 280 -500 0 0 {name=xRES}
C {lab_wire.sym} 280 -590 0 1 {name=p9 sig_type=std_logic lab=VDD}
C {ROI_LIF_NEURON_UNIC-CASS/work/threshold_circuit/xschem/threshold_comparator.sym} 600 -240 0 0 {name=xCOMP}
