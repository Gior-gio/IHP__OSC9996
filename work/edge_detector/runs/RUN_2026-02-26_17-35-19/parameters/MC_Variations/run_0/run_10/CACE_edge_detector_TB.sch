...
.control
    ...
    * Save output
    echo $&pulse_width > /foss/designs/chipathon_2025/designs/ihp-sg13g2/edge_detector/runs/RUN_2026-02-26_17-35-19/parameters/MC_Variations/run_0/run_10/CACE_edge_detector_TB_0.data
.endc
"}
C {devices/code_shown.sym} 20 -590 0 0 {name=SETUP only_toplevel=true
format="tcleval( @value )"
value="
.lib /foss/pdks/ihp-sg13g2/libs.tech/ngspice/models/cornerMOSlv.lib mos_tt_stat
.include /foss/designs/chipathon_2025/designs/ihp-sg13g2/edge_detector/netlist/schematic/edge_detector.spice
