...
N 1840 -380 1840 -310 {lab=VDD}
N 1840 -170 1840 -100 {lab=VSS}
N 1220 -240 1300 -240 {lab=COMP}
N 1380 -380 1380 -310 {lab=VDD}
N 1380 -170 1380 -100 {lab=VSS}
N 1500 -240 1540 -240 {lab=COMPB}
N 1960 -240 2000 -240 {lab=SPIKEB}
C {OSC9996-main/schematic/xschem/integrator.sym} 120 -80 0 0 {name=xINT}
C {OSC9996-main/schematic/xschem/spike_generator.sym} 940 -210 0 0 {name=xSPK}
...
C {OSC9996-main/schematic/xschem/resistence_bank.sym} 280 -500 0 0 {name=xRES}
C {lab_wire.sym} 280 -590 0 1 {name=p9 sig_type=std_logic lab=VDD}
C {OSC9996-main/schematic/xschem/threshold_comparator.sym} 600 -240 0 0 {name=xCOMP}
...
C {OSC9996-main/schematic/xschem/gate_buff_pad.sym} 1840 -240 0 0 {name=xSPKB}
...
C {OSC9996-main/schematic/xschem/gate_buff_pad.sym} 1380 -240 0 0 {name=xCOMPB}
